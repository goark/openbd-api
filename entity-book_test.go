...
func TestBooks(t *testing.T) {
	testCases := []struct {
		...
		{
			jsnStr:      `[{}]`,
			str:         `[{"onix":{"RecordReference":"","NotificationType":"","ProductIdentifier":{"ProductIDType":"","IDValue":""},"DescriptiveDetail":{"ProductComposition":"","ProductForm":"","Collection":{"CollectionType":"","CollectionSequence":{},"TitleDetail":{}},"TitleDetail":{"TitleType":"","TitleElement":{"TitleElementLevel":"","TitleText":{"content":""}}}},"CollateralDetail":{},"PublishingDetail":{"Imprint":{"ImprintName":""},"Publisher":{"PublishingRole":"","PublisherName":""}},"ProductSupply":{"SupplyDetail":{"ReturnsConditions":{"ReturnsCodeType":"","ReturnsCode":""},"ProductAvailability":""}}},"hanmoto":{"dateshuppan":"","datemodified":"","datecreated":"","datekoukai":""},"summary":{"isbn":"","title":"","volume":"","series":"","publisher":"","pubdate":"","author":"","cover":""}}]`,
			valid:       []bool{false},
			ids:         []string{""},
			isbn:        []string{""},
			title:       []string{""},
